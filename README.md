...
| **Operations**                  | Tₙ (transposition by n semitones), I (inversion), Complementation (S<sup>_c_</sup>), Multiplication (M), R (retrograde), RI (retrograde-inversion). Transposition and inversion preserve the ICV. R and RI are available only for ordered sets. |
